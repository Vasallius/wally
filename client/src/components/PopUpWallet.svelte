<script>
	...
	export let WalletRecords = [];

	function addToRecords() {
		WalletRecords = [
			...WalletRecords,
			{ id: WalletRecords.length, title: label, balance: balance }
		];
	}
	...
	function handleSubmit(event) {
		...
		// create new wallet record object with user input
		addToRecords();

		// log updated WalletRecords array for testing
